...
#include "imgui.h"
#include "Prometheus/Platform/OpenGL/ImGuiOpenGLRenderer.h"
...
namespace Prometheus {
	...
	void ImGuiLayer::OnAttach()
	{
		...
		// TEMPORARY: should eventually use Prometheus key codes
	...
	void ImGuiLayer::OnEvent(Event& event) {
		...
		dispatcher.Dispatch<WindowResizeEvent>(PM_BIND_EVENT_FN(ImGuiLayer::OnWindowResizedEvent));
	}
